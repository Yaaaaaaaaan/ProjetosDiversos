<?php
 ...
 if(isset($_SESSION['nick'])){
    $slcOs="select * from fornecedor order by idFornec desc";
          ...
          <tbody>        
            <?php
              while( $exbColAtrIn = mysqli_fetch_array($rsltOs)){
                  echo "<tr><td>".$exbColAtrIn['idFornec']."</td>";
                  echo "<td>".$exbColAtrIn['nomeFnc']."</td>";
                  echo "<td> ".$exbColAtrIn['cpfFnc']."</td>";
                  echo "<td>".$exbColAtrIn['cnpjFnc']."</td>";
                  echo "<td>".$exbColAtrIn['nascimentoFnc']."</td>";
                  echo "<td>".$exbColAtrIn['idOperatFnc']."</td>"; 
                    switch($_SESSION["rank"]){
                      case 5:
