<?php
	...
	//echo "Essa é a senha;".$nome.$nascimento.$usuario.$cpf.$hash;
			$result=mysqli_query($link,"insert into operador (usuarioOp, senhaOp, cpfOp, nomeOp, nascimentoOp, rankOp) values ('$usuario', '$hash', '$cpf', '$nome', '$nascimento', '$rank' )")or die (mysqli_error());
			if($result){
				$_SESSION["nome"]=$nome;
